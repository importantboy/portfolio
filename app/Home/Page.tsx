...
const IconWrapper = ({
  ...
  <div
    className={`
            ...
            ${
              isHighlighted
                ? " bg-gray-100/80 border-blue-400/50 dark:shadow-blue-500/20 shadow-blue-400/30 shadow-2xl animate-breathing-glow"
                : ` bg-white/60 dark:border-white/20 border-gray-300/60 ${
